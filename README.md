...
* One point for every alphanumeric character in the retailer name. rec1: 6 rec2: 14
* 50 points if the total is a round dollar amount with no cents. rec1: 0 rec2: 50 
* 25 points if the total is a multiple of `0.25`. rec1: 0 rec2: 25
* 5 points for every two items on the receipt. rec1: 10 rec2: 10
* If the trimmed length of the item description is a multiple of 3,  rec1: 0+3+0+3=6  rec2: 0
        multiply the price by `0.2` and 
        round up to the nearest integer. 
        The result is the number of points earned.
* 6 points if the day in the purchase date is odd. rec1: 6 rec2: 0
* 10 points if the time of purchase is after 2:00pm and before 4:00pm. rec2: 10
